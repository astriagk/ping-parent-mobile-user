...
/// Map controls overlay widget for TomTom Maps
/// Provides zoom, location, and layer controls for the map
class TTMapControls extends StatelessWidget {
...
/// Location info card overlay for TomTom Maps
/// Shows selected location details with optional navigation
class TTLocationInfoCard extends StatelessWidget {
  final String title;
...
/// Route info card showing distance, duration, and waypoints for TomTom Maps
class TTRouteInfoCard extends StatelessWidget {
  final String distance;
  final String duration;
...
/// Loading overlay for TomTom map
class TTLoadingOverlay extends StatelessWidget {
  final String? message;
  final Color? backgroundColor;

  const TTLoadingOverlay({
    super.key,
    this.message,
    this.backgroundColor,
  });
...
/// Search bar overlay for TomTom map
...
/// Tracking stats overlay for TomTom Maps
class TTTrackingStats extends StatelessWidget {
  final String distance;
  final String duration;
  final String? speed;
