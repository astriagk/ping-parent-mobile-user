...
class OFMLocationPickerScreen extends StatefulWidget {
  ...
  @override
  State<OFMLocationPickerScreen> createState() =>
      _OFMLocationPickerScreenState();
}

class _OFMLocationPickerScreenState extends State<OFMLocationPickerScreen> {
