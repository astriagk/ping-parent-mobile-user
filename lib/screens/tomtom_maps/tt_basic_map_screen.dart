...
/// Basic TomTom Map example with user location
/// Shows how to display a simple map with current location marker
/// and multiple tile style options
class TTBasicMapScreen extends StatefulWidget {
  const TTBasicMapScreen({super.key});

  @override
  State<TTBasicMapScreen> createState() => _TTBasicMapScreenState();
}

class _TTBasicMapScreenState extends State<TTBasicMapScreen> {
  ...
  void _showTileSelector() {
    final tiles = TomTomConfig.allTileOptions;
  ...
  Widget _buildMap() {
    final tileUrl = TomTomConfig.allTileOptions[_selectedTileIndex]['url']!;
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  TomTomConfig.allTileOptions[_selectedTileIndex]['name']!,
                  style: TextStyle(
                    fontSize: 12,
