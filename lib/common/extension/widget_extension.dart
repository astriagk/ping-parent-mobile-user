  ...
  Widget decorated({
    ...
    ShapeDecoration decoration = ShapeDecoration(
      ...
      shape: SmoothRectangleBorder(
          side: BorderSide(color: sideColor ?? appTheme.trans),
          borderRadius: SmoothBorderRadius.only(
              topLeft: SmoothRadius(
                  cornerRadius: tLRadius ?? allRadius, cornerSmoothing: 1),
              topRight: SmoothRadius(
                  cornerRadius: tRRadius ?? allRadius, cornerSmoothing: 1),
              bottomLeft: SmoothRadius(
                  cornerRadius: bLRadius ?? allRadius, cornerSmoothing: 1),
              bottomRight: SmoothRadius(
                  cornerRadius: bRRadius ?? allRadius, cornerSmoothing: 1))),
    );
    return DecoratedBox(
      decoration: decoration,
      position: position,
